...
//            out.print(dateTime.getMonth());
      ...
      out.write("             + \"&body=\"+escape(document.getElementById('msg').value);\n");
      out.write("    \n");
      ...
      out.write("        $.ajax({\n");
      out.write("            url:\"trail2.jsp\",\n");
      out.write("            type:\"post\",\n");
      out.write("            data:  {\n");
      out.write("    uid: \"LP003002\"\n");
      out.write("  },\n");
...
//                                    out.print();
      ...
      out.print(str);
      out.write("\" class=\"btn btn-sm btn-success\"><i class=\"glyphicon glyphicon-eye-open\"></i>    View</button></td>\n");
      out.write("</tr>                                    \n");
      out.write("<!--                                 \n");
